...
export const Academy: React.FC<Props> = ({ subscriptionTier: externalSubscriptionTier = 'free', onNavigateToUpgrade }) => {
  ...
  return (
    <div className="p-4 md:p-6 max-w-7xl mx-auto pb-20 animate-in fade-in duration-500">
      ...
      {/* ── Category Filters ── */}
      {/* Mobile: horizontally-scrollable single row — with 8+ categories at
          their full Romanian labels, a wrapping row stacked one-per-line ate
          a full screen before a single article was visible. -mx-4 px-4
          bleeds the scroll area to the page edges so pills can be swiped
          past the content padding.
      ...
      {paywallArticle && (
        <PremiumUpgradeModal
          triggerItem={{
            ...
            meta: `${paywallArticle.readTime} min · ${paywallArticle.difficulty}`,
          }}
