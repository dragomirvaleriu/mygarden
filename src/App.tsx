      ...
      <ErrorBoundary>
        ...
        {(() => {
          switch (currentPage) {
            ...
            case Page.Explore: return <ExploreGarden organizationId={profile.organizationId} subscriptionTier={subscriptionTier} onNavigateToUpgrade={() => navigateTo(Page.Administration)} />;
