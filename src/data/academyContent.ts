...
export const ARTICLES_RO: ArticleMeta[] = [
  ...
  },
  {
    ...
    excerpt: 'Un ghid simplu, cu poze mintale ușor de reținut, ca să știi exact ce crește în gazonul tău și cum îl elimini fără să distrugi restul ierbii.',
    category: 'protocoale-baza',
    categoryLabel: 'Protocoale de Bază',
    isPremium: false,
    readTime: 6,
  ...
  },
  {
    ...
    excerpt: 'Sub copaci mari sau în colțuri umbroase gazonul se răreşte mereu, oricât ai încerca. Iată alternativa care chiar funcționează acolo.',
    category: 'protocoale-baza',
    categoryLabel: 'Protocoale de Bază',
    isPremium: false,
    readTime: 5,
  ...
  },
  {
    ...
    excerpt: 'Frunze cu puncte argintii și o pânză fină, aproape invizibilă. Nu e o ciupercă — sunt niște acarieni minusculi, și au un punct slab: le e frică de apă.',
    category: 'managementul-bolilor',
    categoryLabel: 'Managementul Bolilor',
    isPremium: false,
    readTime: 5,
  ...
  },
  {
    ...
    excerpt: 'Sacul de semințe de la magazin are un nume ciudat pe etichetă și tu nu știi ce înseamnă. Iată ce se ascunde de fapt în spatele lui Lolium, Festuca sau Poa pratensis.',
    category: 'protocoale-baza',
    categoryLabel: 'Protocoale de Bază',
    isPremium: false,
    readTime: 7,
  ...
  },
  {
    ...
    excerpt: 'Trandafirii nu sunt capricioși fără motiv — au niște cerințe foarte precise de sol, lumină și orientare. Dacă le respecți, diferența se vede din prima vară.',
    category: 'protocoale-baza',
    categoryLabel: 'Protocoale de Bază',
    isPremium: false,
    readTime: 6,
  ...
  },
  {
    ...
    excerpt: 'Nu toți trandafirii sunt la fel — unii sunt făcuți pentru ghiveci pe balcon, alții pentru garduri vii, alții cață pe un gard. Iată cum alegi tipul potrivit pentru locul tău.',
    category: 'protocoale-baza',
    categoryLabel: 'Protocoale de Bază',
    isPremium: false,
    readTime: 6,
  ...
  },
  {
    ...
    excerpt: 'Câți muguri lași la tăiere depinde de tipul de trandafir și de vigoarea lui — greșești aici și ori nu mai înflorește, ori epuizezi tufa în câțiva ani.',
    category: 'protocoale-baza',
    categoryLabel: 'Protocoale de Bază',
    isPremium: true,
    readTime: 9,
  ...
  },
  {
    ...
    excerpt: 'Vrei să renunți la furtunul cu care alergi prin curte seară de seară? Iată cum se proiectează un sistem de aspersoare, pas cu pas, înainte să sapi primul șanț.',
    category: 'protocoale-baza',
    categoryLabel: 'Protocoale de Bază',
    isPremium: false,
    readTime: 7,
