...
export const ARTICLES_RO: ArticleMeta[] = [
  ...
  },
  {
    ...
    excerpt: 'De la terenul brut la primul fir de iarbă: pregătirea solului, calculul exact al cantității de sămânță, semănatul, udarea critică din primele 3 săptămâni și regula primei tunderi.',
    category: 'protocoale-baza',
    categoryLabel: 'Protocoale de Bază',
    isPremium: true,
    readTime: 12,
    ...
    coverEmoji: '🌱',
    tags: ['insamantare', 'teren', 'seminte', 'gazon', 'udare germinatie', 'prima tundere'],
